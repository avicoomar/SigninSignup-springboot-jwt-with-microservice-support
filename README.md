...
Note: API Gateway runs on port 9090 and signin-signup service on port 9001.                                                                                                   user-service requires the username too (Refer API calls in the attached screenshots)
